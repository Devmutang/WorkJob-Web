...
export const CompanyOverviewForm = ({
  ...
  const handlePromptGeneration = async () => {
    try {
      setIsPrompting(true);
      const customPrompt = `สร้างเนื้อหาเกี่ยวกับภาพรวมของ ${rollname} โดยรวมข้อมูลเกี่ยวกับประวัติความเป็นมา, วัตถุประสงค์, คุณลักษณะเด่น, กลุ่มผู้ใช้งาน, และผลกระทบต่ออุตสาหกรรม มุ่งเน้นการให้ข้อมูลที่ครอบคลุมแต่กระชับ เหมาะสำหรับผู้อ่านที่ไม่คุ้นเคยกับแพลตฟอร์มนี้`;
  ...
  return (
    <div className="mt-6 border bg-neutral-100 rounded-md p-4">
      ...
      {!isEditing && (
        ...
        >
          {!initialData.overview && "ไม่มีภาพรวม"}
      ...
      {isEditing && (
        <>
          ...
          หมายเหตุ: พิมพ์ชื่อบริษัทในที่นี้เพื่อสร้างเนื้อหาเกี่ยวกับภาพรวม"
          </p>
